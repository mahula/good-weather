...
public class ForecastBottomSheetDialogFragment extends BottomSheetDialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        ...
        description = mWeather.getRain() != null ? description + " (" + mWeather.getRain() + "mm)" : description;
        description = mWeather.getSnow() != null ? description + " (" + mWeather.getSnow() + "mm)" : description;
